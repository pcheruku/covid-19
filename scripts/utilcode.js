function getCountryData() {
	var htmlData = "<div class='row header'><div class='cell' style='text-align:left;padding-left:5px;'>Country</div><div class='cell'>Positive</div><div class='cell'>Negative</div><div class='cell'>Pending</div><div class='cell'>Total</div><div class='cell'>Recovered</div><div class='cell'>Deaths</div><div class='cell' style='text-align:left;padding-left:25px;'>Modified</div></div>";
	$.getJSON('https://covidtracking.com/api/us', function(data) {
		$.each(data, function(key, value){
			htmlData += "<div class='row'>";
			htmlData += "<div class='cell' style='text-align:left;padding-left:5px;' data-title='Country'>United States (USA)</div>";
